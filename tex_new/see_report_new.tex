...
cam.FocalMode = manual
				...
				\end{figure}
				\newpage
				\item \textbf{Experiment: Large Marker-}The below plot shows the combined plot (X and Y coordinates ) of pick and place of large mass object in three different places(straight, left and right). \\ The mean of the orientation values for each experiments (straight, left and right) is stored. The triangle in the plot is oriented by the mean orientation values.
				\begin{figure}[H]
					\centering
				...
				Y coordinate: pp1 : 0.12, pp2 : 0.12 \\
				Orientation: pp1 : 0.27, pp2 : 0.27
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.56]{small-left}	
					\caption{Distribution plot for Small marker-Left}
				\end{figure}
				\newpage
				\item Experiment: Pick and place of Small marker - Right\\
				X coordinate: pp1 : 0.61, pp2 : 0.61\\
				Y coordinate: pp1 : 1.0, pp2 : 1.0 \\
				Orientation: pp1 : 0.39, pp2 : 0.39
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.56]{small-right}
					\caption{Distribution plot for Small marker-Right}	
				\end{figure}
				\newpage
				\item \textbf{Experiment: Pick and place of Medium marker - Straight}\\
				X coordinate: pp1 : 0.23, pp2 : 0.23\\
				Y coordinate: pp1 : 0.23, pp2 : 0.23 \\
				Orientation: pp1 : 0.39, pp2 : 0.39
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.56]{medium_straight}
					\caption{Distribution plot for medium marker-Straight}	
				\end{figure}
				\newpage
				\item Experiment: Pick and place of Medium marker - Left
				X coordinate: pp1 : 0.51, pp2 : 0.51\\
				Y coordinate: pp1 : 0.51, pp2 : 0.51 \\
				Orientation: pp1 : 0.51, pp2 : 0.51
				\begin{figure}[H]
					\centering
					\includegraphics[scale=0.56]{medium-left}
					\caption{Distribution plot for medium marker-Left}	
				\end{figure}
				\newpage
				\item Experiment: Pick and place of Medium marker - Right\\
				X coordinate: pp1 : 0.39, pp2 : 0.39\\
				Y coordinate: pp1 : 0.39, pp2 : 0.39 \\
				Orientation: pp1 : 2.21, pp2 : 2.21
				\begin{figure}[H]
					\centering
