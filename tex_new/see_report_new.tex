...
cam.FocalMode = manual
				...
				\begin{itemize}
				\item The pose of the object is calculated 50 times by the youbot and the average of all the values is recorded for each trial run.
				\item On average, 3 outliers were detected for every trial run.
				\end{itemize}
				\subsubsection{Distribution plots}
				\begin{itemize}
				\item For the large mass object
				\begin{itemize}
				\item For straight line motion
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{straight_large_x.png}
				\caption{Distribution of X coordinates for straight line motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{straight_large_y.png}
				\caption{Distribution of Y coordinates for straight line motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{straight_large_o.png}
				\caption{Distribution of orientations for straight line motion of large object}
				\end{figure}
				\item For left arc motion
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{left_large_x.png}
				\caption{Distribution of orientations for left arc motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{left_large_y.png}
				\caption{Distribution of orientations for left arc motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{left_large_o.png}
				\caption{Distribution of orientations for left arc motion of large object}
				\end{figure}
				\item For right arc motion
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{right_large_x.png}
				\caption{Distribution of orientations for right arc motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
				\includegraphics[scale=0.5]{right_large_y.png}
				\caption{Distribution of orientations for right arc motion of large object}
				\end{figure}
				\begin{figure}[H]
				\centering
